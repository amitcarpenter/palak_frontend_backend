...
// MongoDB connection
mongoose
  .connect("mongodb://127.0.0.1/Fit_With_Palak")
  .then(() => {
...
app.use("/Source", express.static(path.join(__dirname, "../frontend/Source")));

app.use("/videos", express.static("../frontend/videos"));
app.use("/testimonials", express.static("../frontend/testimonials"));
